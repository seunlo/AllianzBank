    ...
    <div class="card w-100">
      <div class="card-body">
        ...
        <p class="text-primary fw-bold">AllianzBank or any of its staff will never ask you for your account login
          details for any reason. Please disregard any message asking you for any sensitive information regarding your
          account with us. Feel free to call our 24hrs customer representatives in case you have any issue regarding
          your account. </p>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-6">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/password.jpg" alt="Card image cap"
            style="max-height: 155px;min-height: 155px">
          <div class="card-body">
            <a href="changepassword.php" class="btn btn-outline-primary btn-block w-100">Change Password</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-4">
    <div class="card shadowBlack ">
      <img class="card-img-top" src="images/contacts.gif" alt="Card image cap"
        style="max-height: 155px;min-height: 155px">
      <div class="card-body">
        <a href="feedback.php" class="btn btn-outline-primary btn-block w-100">Contact Us</a>
      </div>
    </div>
  </div>
  <?php if (!empty($all_customer['utility_bill']) and !empty($all_customer['passport_photo']) and !empty($all_customer['valid_id'])) { ?>
    ...
    <div class="col-md-4">
      <div class="card shadowBlack ">
        ...
        <div class="card-body">
          <a href="notice.php" class="btn btn-outline-primary btn-block w-100">Transaction History </a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
